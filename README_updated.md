...
git clone https://github.com/SynckDance/gmr-pipeline.git
cd gmr-pipeline
...
```
https://synckdance.github.io/gmr-pipeline/Bata_dance_Sinclair_visualization.html
```
...
@software{gmr_pipeline,
  ...
  author = {Emoghene, Sinclair},
  year = {2024},
  url = {https://github.com/SynckDance/gmr-pipeline}
}
```
